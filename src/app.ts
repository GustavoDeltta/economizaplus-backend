...
export function createApp(controllers?: AppControllers) {
  ...
  if (controllers) {
    ...
    const {
      makeUserController,
    } = require("./infrastructure/factories/MakeUserController");
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const {
      makeAdminController,
    } = require("./infrastructure/factories/MakeAdminController");
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const {
      makeLoginController,
    } = require("./infrastructure/factories/MakeLoginController");
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const {
      makeCategoryController,
    } = require("./infrastructure/factories/MakeCategoryController");
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const {
      makeGoalController,
    } = require("./infrastructure/factories/MakeGoalController");
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const {
      makeCardController,
    } = require("./infrastructure/factories/MakeCardController");
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const {
      makeGoogleLoginController,
    } = require("./infrastructure/factories/MakeGoogleLoginController");
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const {
      makeAIController,
    } = require("./infrastructure/factories/MakeAIController");
    const {
      makeWalletController,
    } = require("./infrastructure/factories/MakeWalletController");
    const {
      makeTransactionController,
    } = require("./infrastructure/factories/MakeTransactionController");
    const {
      makeSavingController,
    } = require("./infrastructure/factories/MakeSavingController");
    const {
      makePasswordRecoveryController,
    } = require("./infrastructure/factories/MakePasswordRecoveryController");
  ...
  app.post("/api/login/google", (req, res) =>
    googleLoginController.login(req, res),
  );
  app.post("/api/auth/forgot-password", (req, res) =>
    passwordRecoveryController.forgotPassword(req, res),
  );
  app.post("/api/auth/reset-password", (req, res) =>
    passwordRecoveryController.resetPassword(req, res),
  );
  ...
  app.get("/api/users/profile", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    userController.getProfile(req, res),
  );
  app.put("/api/users/profile", roleMiddleware("COMMON"), (req, res) =>
  ...
  app.get("/api/admin/users", roleMiddleware("ADMIN"), (req, res) =>
    adminController.getAllUsers(req, res),
  );
  app.get("/api/admin/users/:id", roleMiddleware("ADMIN"), (req, res) =>
    adminController.getUserById(req, res),
  );
  app.put("/api/admin/users/:id", roleMiddleware("ADMIN"), (req, res) =>
    adminController.updateUser(req, res),
  );
  app.delete("/api/admin/users/:id", roleMiddleware("ADMIN"), (req, res) =>
    adminController.deleteUser(req, res),
  );

  // ── Rotas Privadas: Categories ─────────────────────────────────────────────
  app.post("/api/categories", roleMiddleware("COMMON"), (req, res) =>
    categoryController.create(req, res),
  );
  app.get("/api/categories", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    categoryController.getAllByUserId(req, res),
  );
  app.put(
    "/api/categories/:id",
    roleMiddleware("COMMON", "ADMIN"),
  ...
  app.post("/api/goals", roleMiddleware("COMMON"), (req, res) =>
    goalController.create(req, res),
  );
  app.get("/api/goals", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    goalController.getAllByUserId(req, res),
  );
  app.put("/api/goals/:id", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    goalController.update(req, res),
  );
  app.delete("/api/goals/:id", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    goalController.delete(req, res),
  );

  // ── Rotas Privadas: Cards ──────────────────────────────────────────────────
  app.get("/api/cards", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    cardController.getAllByUserId(req, res),
  );
  app.get("/api/cards/:id", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    cardController.getCardById(req, res),
  );
  app.post("/api/cards", roleMiddleware("COMMON"), (req, res) =>
    cardController.create(req, res),
  );
  app.put("/api/cards/:id", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    cardController.update(req, res),
  );
  app.delete("/api/cards/:id", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    cardController.delete(req, res),
  );
  app.patch(
    "/api/cards/:id/pay-invoice",
    roleMiddleware("COMMON"),
    (req, res) => cardController.payInvoice(req, res),
  );

  // ── Rotas Privadas: AI ─────────────────────────────────────────────────────
  app.post("/api/ai/tips", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    aiController.generateTips(req, res),
  );
  app.get("/api/ai/tips", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    aiController.getTips(req, res),
  );

  // ── Rotas Privadas: Wallets ────────────────────────────────────────────────
  app.post("/api/wallets", roleMiddleware("COMMON"), (req, res) =>
    walletController.create(req, res),
  );
  app.get("/api/wallets", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    walletController.getAll(req, res),
  );
  app.get("/api/wallets/:id", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
    walletController.getById(req, res),
  );
  app.delete(
    "/api/wallets/:id",
    roleMiddleware("COMMON", "ADMIN"),
    (req, res) => walletController.delete(req, res),
  );

  // ── Rotas Privadas: Transactions ───────────────────────────────────────────
  app.post("/api/transactions", roleMiddleware("COMMON"), (req, res) =>
    transactionController.create(req, res),
  );
  app.get("/api/transactions", roleMiddleware("COMMON", "ADMIN"), (req, res) =>
  ...
  app.post("/api/savings", roleMiddleware("COMMON"), (req, res) =>
    savingController.create(req, res),
  );
  app.get(
    "/api/savings/goal/:goalId",
    roleMiddleware("COMMON", "ADMIN"),
    (req, res) => savingController.getByGoal(req, res),
  );
