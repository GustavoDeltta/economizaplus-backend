...
export interface InterfaceGoalRepository {
    ...
    update(id: string, name: string, description: string, walletId: string, targetAmount: Decimal, currentAmount: Decimal, percentageComplete: Decimal, deadline: Date, isCompleted: boolean, tx?: any): Promise<Goal>;
